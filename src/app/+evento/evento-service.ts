...
export class EventoService {
  ...
  eventUrl = "https://tukio-1cb4e.firebaseio.com/Events.json";

  getEventos():Observable<IEvento[]> {
    return this.http.get<IEvento[]>(this.eventUrl);
  }
...
const EVENTS: IEvento[] = [
    ...
    },
    {
      id: 2,
      name: 'ng-nl',
      startDate: new Date('3/4/2037'),
      endDate: new Date('4/4/2037'),
      time: '9:00 am',
      price: 950.00,
    ...
    },
    {
      ...
      startDate: new Date('2/4/2037'),
      endDate: new Date('6/5/2037'),
      time: '8:00 am',
      price: 800.00,
